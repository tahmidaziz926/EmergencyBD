      ...
      <div style={styles.layout}>
        ...
        <div style={styles.leftPanel}>
          <div style={styles.leftContent}>
            ...
            <div style={styles.stepsContainer}>
              {[
                ...
                <div key={s.num} style={styles.stepItem}>
                  ...
                  {s.num < 3 && <div style={{ ...styles.stepLine, ...(step > s.num ? styles.stepLineDone : {}) }}></div>}
                </div>
              ))}
            </div>
            ...
            {selectedTypeData && (
              <div style={{ ...styles.selectedPreview, borderColor: `${selectedTypeData.color}40`, backgroundColor: `${selectedTypeData.color}08` }}>
        ...
        <div style={styles.rightPanel}>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            {step === 2 && (
              <div style={{ animation: "slideIn 0.3s ease" }}>
                <h3 style={styles.stepTitle}>Step 2 — Describe the Emergency</h3>
                <p style={styles.stepSubtitle}>Provide as much detail as possible</p>

                <div style={styles.field}>
                  <label style={styles.fieldLabel}>📝 Description <span style={styles.required}>*</span></label>
                  <textarea
                    rows="8"
                    placeholder="Describe the emergency in detail... Include location details, number of people involved, and any other relevant information."
                    value={description}
              ...
              <div style={{ animation: "slideIn 0.3s ease" }}>
                ...
                <div style={styles.reviewCard}>
                  ...
                  <div style={styles.reviewRow}>
                    ...
                    <span style={styles.reviewValue}>{description.substring(0, 80)}{description.length > 80 ? "..." : ""}</span>
                  </div>
                  <div style={styles.reviewDivider}></div>
                  <div style={styles.reviewRow}>
                  ...
                  <div style={styles.reviewRow}>
                    ...
                    <span style={{ color: "#ffaa00", fontWeight: "600", fontSize: "14px" }}>⏳ Will be set to Pending</span>
                  </div>
                </div>
